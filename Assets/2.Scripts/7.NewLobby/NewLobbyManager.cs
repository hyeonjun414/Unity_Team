...
{
    public static NewLobbyManager instance {get; private set;}

    [Header("Panel")]
    public NewLoginPanel loginPanel;
    public NewInConnectPanel inConnectPanel;
    public NewCreateRoomPanel createRoomPanel;
    public NewInLobbyPanel inLobbyPanel;
    public NewInRoomPanel inRoomPanel;
    public NewInfoPanel infoPanel;
